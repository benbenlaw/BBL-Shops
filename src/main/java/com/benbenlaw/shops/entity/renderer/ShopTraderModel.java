...
public class ShopTraderModel extends EntityModel<ShopTraderRenderState> implements HeadedModel, VillagerLikeModel<ShopTraderRenderState> {
    ...
    public ShopTraderModel(ModelPart root) {
        super(root);
    ...
    @Override
    public void setupAnim(ShopTraderRenderState state) {
    ...
    @Override
    public void translateToArms(ShopTraderRenderState state, PoseStack outputPoseStack) {
